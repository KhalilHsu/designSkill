...
- Mood: refined, engineered, focused.
- Palette: black or near-black canvas, white text, cool gray secondary text, one precise blue or teal action color.
- Type: compact sans, tight tracking for large headings.
...
Inspired by product-gallery and craft-led systems.

- Mood: quiet, premium, material, deliberate.
- Palette: warm off-white, carbon black, one deep anchor color such as indigo, brown, green, or plum.
- Type: distinctive display or refined sans, careful letter spacing.
...
Inspired by collaborative productivity systems.

- Mood: helpful, flexible, organized, bright.
- Palette: warm white canvas, dark ink text, one strong action color, multiple small accents for categories.
- Type: readable sans, friendly headline weight.
...
Inspired by colorful work-management systems.

- Mood: energetic, optimistic, modular.
- Palette: light neutral canvas, vivid primary accent, bright pastel cards, occasional gradients.
- Type: geometric sans, bold section heads, relaxed body.
...
Inspired by precise dark-mode app systems.

- Mood: technical, powerful, focused, nocturnal.
- Palette: deep navy/black canvas, white text, blue/indigo action, restrained vivid accents.
- Type: crisp UI sans, tight hierarchy, optional editorial accent font.
...
Inspired by communication and teamwork brands.

- Mood: human, lively, professional, communal.
- Palette: near-white canvas, deep brand color, strong link accent, decorative gradient washes.
- Type: distinctive display face paired with clear body sans.
...
General-purpose style for content-heavy pages.

- Mood: clear, calm, intelligent.
- Palette: neutral canvas, strong text, muted secondary text, one restrained accent.
- Type: expressive display or serif paired with highly readable body sans.
...
- Use precision or command-center styles when trust, power, or technical credibility matters.
- Use approachable or playful styles when reducing intimidation matters.
- Use luxury or editorial styles when perception, taste, and focus matter.
- Use expressive collaboration when the product is people-centered.
- If the user gives no direction, choose the archetype that best matches the content and audience, then write tokens from scratch.
